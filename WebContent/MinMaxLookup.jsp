...
<title>Look up Average Grade</title>
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="col-md-3 col-md-offset-4">
		<form role="form" action="MinMaxLookup" method="POST" id="mainform">
			
			<div class="form-group">
				<div class="radio checked">
					  <label><input type="radio" name="assignment_type" id="homework" value="homework" checked>homework</label>
				</div>
				<div class="radio">
